      ...
      <div class="col-md-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <input type="hidden" name="IdAkun" value="{{ $DataAkun->id_akun }}">

              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">No Akun<span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text"  name="NoAkun" class="form-control col-md-7 col-xs-12" value="{{ $DataAkun->no_akun}}">
                </div>
                @if (count($errors) > 0)
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text"  name="NamaAkun" class="form-control col-md-7 col-xs-12" value="{{ $DataAkun->nama_akun}}">
                </div>
                @if (count($errors) > 0)
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text"  name="KategoriAkun" class="form-control col-md-7 col-xs-12" value="{{ $DataAkun->kategori_akun}}">
                </div>
                @if (count($errors) > 0)
