                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <div class="pull-right">
                      <a href="{{ URL::to('tambahMenu') }}" class="tips btn btn-xs btn-info" title="Tambah Siswa"><i class="fa fa-plus"></i> Tambah</a>
                          ...
                          <tbody>
                            @foreach($rows as $row)
                              <tr>
                                  ...
                                  <td>{{ $row->Group }}</td>
                                  <td>
                                    <a href="{{ URL::to('updateMenu/?Id='.$row->MenuId) }}" class="tips btn btn-xs btn-info" title="Edit"><i class="fa fa-folder-open-o"></i></a>
                                    <button value="{{ $row->MenuId }}" class="tips btn btn-xs btn-danger hapus-siswa" title="Hapus" onclick="validation(this.value)"><i class="fa fa-trash"></i></button>
                                  </td>
                              </tr>
                            @endforeach
                          </tbody>
  ...
  swal(
    ...
    function(isConfirm){   
      if (isConfirm) {     
        setTimeout(function(){
            $.ajax({
              url: "{{ URL::to('hapusMenu/?MenuId=') }}"+val,
              method: 'GET',
            });
