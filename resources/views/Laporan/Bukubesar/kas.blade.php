            ...
            <tbody>
              ...
              @else
                ...
                @foreach($DataLaporan as $laporan)
                  @if($laporan->nilai_d != NULL && $laporan->no_akun == 100 || $laporan->nilai_k != NULL && $laporan->no_akun == 100)
                    <?php 
                      $SaldoKas = $SaldoKas + ($laporan->nilai_d - $laporan->nilai_k);
                    ?>
                    <tr>
                      ...
                      @if($SaldoKas > 0)
                        <td class="text-right">{{ number_format($SaldoKas) }}</td>
                        <td class="text-right">0</td>
                      @else
                        <td class="text-right">0</td>
                        <td class="text-right">{{ number_format(abs($SaldoKas)) }}</td>
                      @endif
                    </tr>
                  @endif
