                            ...
                            <tbody>
                              ...
                              @else
                                ...
                                @foreach($DataLaporan as $laporan)
                                  @if($laporan->nilai_d != NULL && $laporan->no_akun == 500 || $laporan->nilai_k != NULL && $laporan->no_akun == 500)
                                    <?php 
                                      $SaldoSimpananPokok = $SaldoSimpananPokok + $laporan->nilai_d - $laporan->nilai_k;
                                    ?>
                                    <tr>
                                      ...
                                      @if($SaldoSimpananPokok > 0)
                                        <td class="text-right">{{ number_format($SaldoSimpananPokok) }}</td>
                                        <td class="text-right">0</td>
                                      @else
                                        <td class="text-right">0</td>
                                        <td class="text-right">{{ number_format(abs($SaldoSimpananPokok)) }}</td>
                                      @endif
                                    </tr>
                                  @endif
                                @endforeach
