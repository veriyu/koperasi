            ...
            <tbody>
              ...
              @else
                ...
                @foreach($DataLaporan as $laporan)
                  @if($laporan->nilai_d != NULL && $laporan->no_akun == 460 || $laporan->nilai_k != NULL && $laporan->no_akun == 460)
                    <?php 
                      $SaldoSimpananSS = $SaldoSimpananSS + $laporan->nilai_d - $laporan->nilai_k;
                    ?>
                    <tr>
