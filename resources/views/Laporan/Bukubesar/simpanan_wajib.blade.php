            ...
            <tbody>
              ...
              @else
                ...
                @foreach($DataLaporan as $laporan)
                  @if($laporan->nilai_d != NULL && $laporan->no_akun == 510 || $laporan->nilai_k != NULL && $laporan->no_akun == 510)
                    <?php 
                      $SaldoSimpananWajib = $SaldoSimpananWajib + $laporan->nilai_d - $laporan->nilai_k;
                    ?>
                    <tr>
                      ...
                      @if($SaldoSimpananWajib > 0)
                        <td class="text-right">{{ number_format($SaldoSimpananWajib) }}</td>
                        <td class="text-right">0</td>
                      @else
                        <td class="text-right">0</td>
                        <td class="text-right">{{ number_format(abs($SaldoSimpananWajib)) }}</td>
                      @endif
                    </tr>
                  @endif
                @endforeach
